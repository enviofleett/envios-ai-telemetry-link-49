...
import { Wrench, BarChart3, Star } from 'lucide-react';
          ...
          <div className="space-y-6">
            ...
            <Tabs defaultValue="dashboard" className="w-full">
              ...
              <TabsContent value="analytics" className="mt-6">
                <WorkshopAnalyticsDashboard workshopId="workshop-1" />
              </TabsContent>

              <TabsContent value="reviews" className="mt-6">
                <WorkshopReviewSystem workshopId="workshop-1" canRespond={true} />
              </TabsContent>
