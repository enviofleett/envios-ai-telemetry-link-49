...
import { Loader2, AlertTriangle, Users, TrendingUp, DollarSign, ArrowRight, Clock } from 'lucide-react';
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{formatCurrency(analytics.processingPayouts)}</div>
              <p className="text-xs text-muted-foreground">Requested & being processed</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
