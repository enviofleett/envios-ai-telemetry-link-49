...
import { Activity, Users, Truck, TrendingUp } from 'lucide-react';
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">Vehicle V-001 completed route</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium">Maintenance alert for V-005</p>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-3">
              ...
              <button className="p-3 text-left border rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <div className="text-xs text-muted-foreground">Maintenance hub</div>
              </button>
            </div>
          </CardContent>
        </Card>
