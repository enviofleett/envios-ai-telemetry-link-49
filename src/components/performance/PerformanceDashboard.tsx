...
import { GDPRComplianceManager } from '@/components/admin/GDPRComplianceManager';
import { Activity, Database, Zap, AlertTriangle, TrendingUp, RefreshCw, Shield } from 'lucide-react';
