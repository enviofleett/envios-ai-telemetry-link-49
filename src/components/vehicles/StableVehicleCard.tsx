...
interface StableVehicleCardProps {
  vehicle: Vehicle;
...
const StableVehicleCard: React.FC<StableVehicleCardProps> = ({ 
  vehicle, 
  associatedUser,
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors">
                {vehicle.device_name || 'Unknown Vehicle'}
              </CardTitle>
...
export default StableVehicleCard;
