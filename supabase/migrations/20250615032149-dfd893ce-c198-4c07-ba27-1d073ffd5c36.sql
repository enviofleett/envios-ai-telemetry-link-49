...
DROP POLICY IF EXISTS "Users can view their own geocoding configurations" ON public.geocoding_configurations;
CREATE POLICY "Users can view their own geocoding configurations" 
  ON public.geocoding_configurations 
  FOR SELECT 
  USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can create their own geocoding configurations" ON public.geocoding_configurations;
CREATE POLICY "Users can create their own geocoding configurations" 
  ON public.geocoding_configurations 
  FOR INSERT 
  WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their own geocoding configurations" ON public.geocoding_configurations;
CREATE POLICY "Users can update their own geocoding configurations" 
  ON public.geocoding_configurations 
  FOR UPDATE 
  USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can delete their own geocoding configurations" ON public.geocoding_configurations;
...
DROP POLICY IF EXISTS "Users can view their own geocoding usage logs" ON public.geocoding_usage_logs;
CREATE POLICY "Users can view their own geocoding usage logs" 
  ON public.geocoding_usage_logs 
  FOR SELECT 
  USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can create their own geocoding usage logs" ON public.geocoding_usage_logs;
...
DROP POLICY IF EXISTS "Users can view geocoding cache" ON public.geocoding_cache;
...
DROP POLICY IF EXISTS "Users can create geocoding cache entries" ON public.geocoding_cache;
...
DROP POLICY IF EXISTS "Users can update geocoding cache entries" ON public.geocoding_cache;
...
DROP TRIGGER IF EXISTS update_geocoding_configurations_timestamp ON public.geocoding_configurations;
